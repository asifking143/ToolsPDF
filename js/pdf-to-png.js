/**
 * Logic for Specific PDF to PNG Tool
 */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let downloadName = 'converted_pngs.zip';
    ...
    async function handleFile(file) {
        ...
        downloadName = file.name.replace('.pdf', '_PNGs.zip');
    ...
    processBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            for (let i = 1; i <= totalPages; i++) {
                ...
                // For PNG we can preserve transparency, or fill white. Let's fill white usually for PDFs.
